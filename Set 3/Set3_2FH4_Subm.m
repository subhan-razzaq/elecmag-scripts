% Set 3 Exercise MATLAB Code (submitted copy)
% Subhan Razzaq - 400557958
%
% This is the version of the Set 3 script that was handed in. It is identical
% in behaviour to Set3_2FH4.m and is kept alongside it as the submission
% record. It finds the electric field at the origin due to two 8 nC point
% charges at (0,1,1) and (0,-1,1) plus a 4 nC/m uniform line charge lying
% along a diagonal in the xy plane. The line is split into 100000 segments
% and each segment contributes a small Coulomb field to the running total.
